...
public class ClienteController {
	...
	public ResponseEntity<Cliente> update(@PathVariable long id,@RequestBody Cliente clienteDetails) {
		...
		updateCliente.setNomeCliente(clienteDetails.getNomeCliente());
		updateCliente.setCpf(clienteDetails.getCpf());
		updateCliente.setEmailCliente(clienteDetails.getEmailCliente());
		updateCliente.setTelefoneCliente(clienteDetails.getTelefoneCliente());
		updateCliente.setDataNasc(clienteDetails.getDataNasc());
		updateCliente.setEnderecoCliente(clienteDetails.getEnderecoCliente());
